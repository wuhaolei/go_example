...
func constInitCheck_file1() string {
	if file1_c1 != "" {
		fmt.Println("pkg3: const file1_c1 has been initialized")
	}
	if file1_c2 != "" {
		fmt.Println("pkg3: const file1_c2 has been initialized")
	}
	return ""
}
...
func init() {
	fmt.Println("pkg3: file1 first init func invoked")
}
func init() {
	fmt.Println("pkg3: file1 second init func invoked")
}
